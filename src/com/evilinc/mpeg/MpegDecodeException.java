...
/**
 * Describe class <code>MpegDecodeException</code> here.
 *
 * @author <a href="mailto:ian@bork.org"></a>
 * @version 1.0
 */
public class MpegDecodeException extends RuntimeException
{
    public MpegDecodeException(String s)
    {
        super(s);
    }

    public MpegDecodeException()
    {
        super();
    }
}
